  ...
  return (
    <Layout title="Contact us - Cycle Booking System">
      <div className="container mt-5">
        ...
        <div className="row">
          <div className="col-6">
            <img src={contact} alt="contact us Images" />
          </div>

          <div className="col-6 d-flex flex-column justify-content-center align-center">
            <h2>Contact Info</h2>
            <p className="text-justify mt-2">
              ...
              local authorized Probike retailer should be able to provide the
              best services for you and your bicycle.
            </p>
            <div>
              <TiMessage />
              :CycleForEveryone@gmail.com <br />
